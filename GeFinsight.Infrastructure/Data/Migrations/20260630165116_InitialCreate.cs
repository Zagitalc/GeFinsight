    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Colour", "Icon", "IsSystem", "Name" },
                values: new object[,]
                {
                    { 1, "#4e79a7", "🏠", true, "Housing" },
                    { 2, "#59a14f", "🛒", true, "Groceries" },
                    { 3, "#f28e2b", "🚌", true, "Transport" },
                    { 4, "#e15759", "🍽️", true, "Eating Out" },
                    { 5, "#76b7b2", "🎬", true, "Entertainment" },
                    { 6, "#edc948", "💊", true, "Health" },
                    { 7, "#b07aa1", "💰", true, "Savings" },
                    { 8, "#59a14f", "📥", true, "Income" },
                    { 9, "#9c755f", "📦", true, "Other" }
                });
